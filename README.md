...
A dark-themed personal portfolio website built with vanilla HTML, CSS, and JavaScript. Deployed via GitHub Pages.
...
Project Structure
  Portfolio/
    ...
    ├── index.html       # Main file — all HTML, CSS, and JS in one file
    ├── me2.JPG          # Profile photo
    ├── POS.png          # Project 1 screenshot
    ├── icon3.jpg        # Favicon
    └── README.md
